...
function RegisterPage() {
    ...
    return (
        <div className='flex h-[calc(100vh-100px)] items-center justify-center' style={{marginTop:"6%"}}>

            <div className='bg-zinc-950 max-w-md p-8 rounded-md'>
                {
                ...
                <video autoPlay  style={{ borderRadius: "50%", width: "65%",marginLeft:"20%" }} className="img-fluid mb-3">
